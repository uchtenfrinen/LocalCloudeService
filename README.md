...
![Скриншот просмотра фото](screenOfImageVideoViewers.png)
**P.S. Для просмотра фото/видео лучше уменьшать масштаб в терминале, но если слишком сильно уменьшить и включить видео, то кадры будут долго прорисовываться**
...
- **Клиент:** .NET 10 SDK на вашем компьютере (Linux / macOS / Windows)   // Гарантии не даю, тестировал только на CachyOS и на сервере с Ubuntu //.
...
| Enter | Открыть папку / предпросмотр файла (ASCII) |
...
| F3 или `v` | Просмотр изображения / видео как ASCII |
| Q / Esc | Выход |
